...
// Source: github.com/ekefan/bank_panda/db/sqlc (interfaces: Store)
//
// Generated by this command:
//
//	mockgen -package mockdb -destination db/mock/mockStore.go github.com/ekefan/bank_panda/db/sqlc Store
//
